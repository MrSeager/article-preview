        ...
        <Container className='cs-h d-flex flex-column align-items-center justify-content-center'>
            <Container data-aos="flip-up" className='cs-rounded shadow bg-white cs-w'>
                <Row>
                    ...
                    <Col xs={12} lg={8} className='p-5 d-flex flex-column justify-content-between'>
                        ...
                        <Row>
                            ...
                            <Col xs={10} className='ps-4 d-flex flex-column justify-content-center'>
                                <h2 className='h6 m-0 cs-c cs-fw-7'>Michelle Appleton</h2>
                                <p className='cs-c-2 m-0'>28 Jun 2020</p>
                            </Col>
                            <Col xs={1} className='p-0 cs-anchor'>
                                <Button onClick={toggleContainer} className='cs-btn rounded-circle'><Image fluid src={ImgShare} alt='share' className='cs-img-filter' /></Button>
                                {showContainer && (
                                <Container data-aos="fade-up" className='cs-share rounded d-flex flex-row align-items-center justify-content-center px-5 py-2 gap-3 shadow'>
