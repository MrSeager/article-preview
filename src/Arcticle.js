                ...
                <Row>
                    ...
                    <Col xs={12} lg={8} className='px-5 py-4 p-lg-5 d-flex flex-column justify-content-between'>
                        ...
                        <Row className='cs-anchor'>
                            <Col xs={2} lg={1} className='p-0 d-flex flex-column justify-content-center'>
                            ...
                            <Col xs={2} lg={1} style={{ zIndex: 2 }} className='p-0 cs-anchor d-flex flex-column justify-content-center'>
                                <Button onClick={toggleContainer} className='cs-btn rounded-circle p-1'><Image fluid src={ImgShare} alt='share' className='cs-img-filter w-50 h-50' /></Button>
                            </Col>
                            {showContainer && (
